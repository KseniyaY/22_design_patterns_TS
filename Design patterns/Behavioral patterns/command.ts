 ...
 * Usage examples: The Command pattern is pretty common in TypeScript code. Most often it’s used
as an alternative for callbacks to parameterizing UI elements with actions. 
...
an abstract/interface type (sender) which invokes a method in 
